...
@property (nonatomic, copy) void (^textToolDidTap)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolDidPan)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolDidPinch)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolDidRotate)(BOOL isHidden);
