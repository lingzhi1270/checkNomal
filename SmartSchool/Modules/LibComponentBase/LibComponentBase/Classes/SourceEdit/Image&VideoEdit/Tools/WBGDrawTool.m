...
- (UIImage *)buildImage {
    UIGraphicsBeginImageContextWithOptions(_originalImageSize, NO, self.editor.editImage.scale);
    [self.editor.editImage drawAtPoint:CGPointZero];
...
- (void)setup {
    //初始化一些东西
    _originalImageSize   = self.editor.editImage.size;
...
- (void)cleanup {
//    self.editor.scratchView.userInteractionEnabled = NO;
