...
@property (nonatomic, copy) void (^textToolViewDidTap)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolViewDidPan)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolViewDidPinch)(BOOL isHidden);
@property (nonatomic, copy) void (^textToolViewDidRotate)(BOOL isHidden);
