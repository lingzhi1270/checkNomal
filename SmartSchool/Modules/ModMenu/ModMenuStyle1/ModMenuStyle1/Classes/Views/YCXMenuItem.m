...
+ (instancetype)menuItem:(NSString *)title image:(UIImage *)image target:(id)target unreadNumber:(NSInteger)unreadNumber action:(SEL)action {
    YCXMenuItem *item = [[YCXMenuItem alloc] init:title image:image tag:0 unreadNumber:(NSInteger)unreadNumber userInfo:nil target:target action:action];
...
+ (instancetype)menuItem:(NSString *)title image:(UIImage *)image tag:(NSInteger)tag unreadNumber:(NSInteger)unreadNumber userInfo:(NSDictionary *)userInfo {
    YCXMenuItem *item = [[YCXMenuItem alloc] init:title image:image tag:tag unreadNumber:unreadNumber userInfo:userInfo target:nil action:NULL];
    item.alignment = NSTextAlignmentCenter;
...
+ (instancetype)menuTitle:(NSString *)title withIcon:(UIImage *)icon unreadNumber:(NSInteger)unreadNumber {
    YCXMenuItem *item = [[YCXMenuItem alloc] init:title image:icon tag:0 unreadNumber:unreadNumber userInfo:nil target:nil action:NULL];
...
/// init
- (id)init:(NSString *)title image:(UIImage *)image tag:(NSInteger)tag unreadNumber:(NSInteger)unreadNumber userInfo:(NSDictionary *)userInfo target:(id)target action:(SEL) action {
