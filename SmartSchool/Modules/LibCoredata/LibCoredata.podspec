Pod::Spec.new do |spec|
    ...
    # 来源
    spec.source                   = {:path => './LibCoredata', :tag => spec.version.to_s }
    # 最低编译版本
    spec.ios.deployment_target    = '10.0'
    # 源码文件
    spec.source_files             = 'LibCoredata'
    # 子目录
    spec.subspec 'Classes' do |ss|
        ss.source_files           = 'LibCoredata/Classes/**/*'
    end
    
    # 资源文件
     spec.resource_bundles         = {
       'LibCoredata' => ['LibCoredata/Assets/*.xcdatamodeld']
     }
