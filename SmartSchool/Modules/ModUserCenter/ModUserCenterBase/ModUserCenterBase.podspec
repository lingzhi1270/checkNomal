Pod::Spec.new do |spec|
    ...
    # 来源
    spec.source                   = {:path => './ModUserCenterBase', :tag => spec.version.to_s }
    # 最低编译版本
    spec.ios.deployment_target    = '10.0'
    # 源码文件
    spec.source_files             = 'ModUserCenterBase'
    # 子目录
    spec.subspec 'Classes' do |ss|
        ss.source_files             = 'ModUserCenterBase/Classes/**/*'
    end
    
    # 资源文件
    # spec.resource_bundles         = {
    #   'ModUserCenterBase' => ['ModUserCenterBase/Assets/Images/**/*']
    # }
