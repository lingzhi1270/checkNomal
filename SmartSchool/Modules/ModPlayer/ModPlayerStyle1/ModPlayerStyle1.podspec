Pod::Spec.new do |spec|
    # 库名
    spec.name                     = "ModPlayerStyle1"
    # 库版本
    spec.version                  = "1.0.0"
    # 库简介
    spec.summary                  = "音视频播放样式一"
    # 库链接
    ...
    # 来源
    spec.source                   = {:path => './ModPlayerStyle1', :tag => spec.version.to_s }
    # 最低编译版本
    spec.ios.deployment_target    = '10.0'
    # 源码文件
    spec.source_files             = 'ModPlayerStyle1'
    # 子目录
    spec.subspec 'Classes' do |ss|
        ss.source_files             = 'ModPlayerStyle1/Classes/**/*'
    end
